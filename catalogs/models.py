...
class Book(TimeStampedModel):
    ...
    supplementary_content = models.CharField(max_length=10, choices=CHOICES, default=CHOICE_1)
    content_type = models.CharField(max_length=10, choices=CHOICES, default=CHOICE_1)
    media_type = models.CharField(max_length=10, choices=CHOICES, default=CHOICE_1)
    carrier_type = models.CharField(max_length=10, choices=CHOICES, default=CHOICE_1)
    ...
    call_number = models.CharField(max_length=10, choices=CHOICES, default=CHOICE_1)
    accession = models.CharField(max_length=255)
    language = models.CharField(max_length=10, choices=CHOICES, default=CHOICE_1)
    library_location = models.CharField(max_length=10, choices=CHOICES, default=CHOICE_1)
